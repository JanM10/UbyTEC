...
@Component({
  selector: 'app-updatecomercio',
  templateUrl: './updatecomercio.component.html',
  styleUrls: ['./updatecomercio.component.css']
})
export class UpdatecomercioComponent implements OnInit {
