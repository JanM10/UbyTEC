...
@Component({
  selector: 'app-deleterepartidor',
  templateUrl: './deleterepartidor.component.html',
  styleUrls: ['./deleterepartidor.component.css']
})
export class DeleterepartidorComponent implements OnInit {
