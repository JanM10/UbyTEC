...
@Component({
  selector: 'app-updaterepartidor',
  templateUrl: './updaterepartidor.component.html',
  styleUrls: ['./updaterepartidor.component.css']
})
export class UpdaterepartidorComponent implements OnInit {
