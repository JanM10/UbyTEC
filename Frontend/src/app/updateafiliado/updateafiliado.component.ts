...
@Component({
  selector: 'app-updateafiliado',
  templateUrl: './updateafiliado.component.html',
  styleUrls: ['./updateafiliado.component.css']
})
export class UpdateafiliadoComponent implements OnInit {
