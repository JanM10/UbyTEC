...
@Component({
  selector: 'app-deleteafiliado',
  templateUrl: './deleteafiliado.component.html',
  styleUrls: ['./deleteafiliado.component.css']
})
export class DeleteafiliadoComponent implements OnInit {
